 ...
 * @param  {Number} fillOpacity      the fill opacity
...
const sparkline = function sparkline({
  ...
  // fill
  settings.fill = isColor(fill) ? fill : defaults.fill;

  // fillOpacity
  settings.fillOpacity = num(fillOpacity, { ge: 0, le: 1 }) || defaults.fillOpacity;
