---
name: Bug report
about: Create a report to help us improve node-sparkline
title: ''
labels: ''
assignees: ''
...
* [ ] I have searched the [issue tracker](https://github.com/elysiumphase/node-sparkline/issues) for an issue that matches the one I want to file, without success.
...
* **Node Version**:
* **NPM Version**:
* **node-sparkline Version**:
* **Last Known Working node-sparkline Version**:
